...
export class Spar extends Scene {
  ...
  create() {
    ...
    this.events.on('enemyGo', this.enemyAction.bind(this));
    ...
    EventBus.on('updateStateMachine', () => this.updateStateMachine());
    ...
    // note: We want to delay two function below until showStatsAndRemoveFight is done
      ...
      do {
        ...
        (action === 'punch' &&
          this.enemy.currentStamina <
            this.enemyCombatActions.attackTypes.punch.requiredStamina) ||
        (action === 'kick' &&
          this.enemy.currentStamina <
            this.enemyCombatActions.attackTypes.kick.requiredStamina) ||
        (action === 'guard' &&
          !(
            this.enemy.currentHealth < this.enemy.totalHealth * 0.5 ||
