...
function App() {
  ...
  if (window.innerWidth < 480) {
    return (
      <div>
        This game is best enjoyed with a horizontal screen. Please turn your
        phone sideways and refresh {':)'}
      </div>
    );
  }
    ...
    <div id="app">
            ...
            <div style={{ width: '50%', alignItems: 'center' }}>
              {!showRegister && !showLogin && (
                ...
                >
                  <p>WELCOME!</p>
                  <p>
                    CREATE NEW USER OR <br></br>SIGN IN TO PLAY THE GAME!
                  </p>
                </div>
              )}
              {showRegister && (
      ...
      <div id="rightColumn">
        ...
        <div id="gridContainerRight">
          ...
          <div className="gridTextRight" style={{ gridArea: '2 / 4' }}>
            RESTART
          </div>
          <button
            type="button"
          ...
          <div className="gridTextRight" style={{ gridArea: '6 / 4' }}>
            LOAD
          </div>
          <div className="gridTextRight" style={{ gridArea: '8 / 4' }}>
            ACCOUNT
          </div>
        </div>
